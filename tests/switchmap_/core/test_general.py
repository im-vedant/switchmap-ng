...
def test_cleanstring(random_string):
...
def test_random_hash():
    ...
    assert bool(int(result, 16))

def test_root_directory():
    """Testing function root_directory."""
    # Test result
    result = general.root_directory()
    assert result.endswith("{}switchmap-ng".format(os.sep))
...
def test_group_consecutive():
    ...
    items = [
        ...
        [2, 3, 4, 15, 16, 15, 16, 15, 16, 17, 20, 5, 12, 13, 14, 15, 16, 15, 16],
...
def test_human_readable():
    ...
    expecteds = [
        "100.0", "100.0Z", "100.0Z",
        "1000.0", "1.0KZ", "1000.0Z",
        "9.8K", "10.0KZ", "9.8KZ",
        "97.7K", "100.0KZ", "97.7KZ",
        "953.7M", "1.0GZ", "953.7MZ",
        "931.3G", "1.0TZ", "931.3GZ",
        "909.5T", "1.0PZ", "909.5TZ",
    ]
    results = []
    arguments = [
        {"storage": True, "suffix": ""},
