...
def test_macs(test_interfaces):
    ...
    expecteds = [
        [
            ...
            MacState(mac="b8a44f16f19e", organization=None),                MacState(mac="baa350428471", organization=None),
...
def test_ips(test_interfaces):
    ...
    for key, interface in enumerate(test_interfaces):
        ...
        result = tester.ips()
        assert result == expecteds[key]
def test_macips(test_interfaces):
